<div align="center"> <img src="https://github.com/nvim-mini/assets/blob/main/logo-2/logo-pairs_readme.png" alt="mini.pairs"/> </div>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td rowspan=2>Standalone plugin</td> <td>Main</td> <td><code>add('nvim-mini/mini.pairs')</code></td>
        </tr>
        <tr>
            <td>Stable</td> <td><code>add({ source = 'nvim-mini/mini.pairs', checkout = 'stable' })</code></td>
        </tr>
    </tbody>
</table>
</details>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Main</td> <td><code>{ 'nvim-mini/mini.pairs', version = false },</code></td>
        </tr>
        <tr>
            <td>Stable</td> <td><code>{ 'nvim-mini/mini.pairs', version = '*' },</code></td>
        </tr>
    </tbody>
</table>
</details>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td rowspan=2>Standalone plugin</td> <td>Main</td> <td><code>Plug 'nvim-mini/mini.pairs'</code></td>
        </tr>
        <tr>
            <td>Stable</td> <td><code>Plug 'nvim-mini/mini.pairs', { 'branch': 'stable' }</code></td>
        </tr>
    </tbody>
</table>
</details>
