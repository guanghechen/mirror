...
-- lua functions
function M.NvimTmuxNavigateLeft()
	navigate("h")
end
function M.NvimTmuxNavigateDown()
	navigate("j")
end
function M.NvimTmuxNavigateUp()
	navigate("k")
end
function M.NvimTmuxNavigateRight()
	navigate("l")
end
function M.NvimTmuxNavigateLastActive()
	navigate("p")
end
function M.NvimTmuxNavigateNext()
	navigate("n")
end
