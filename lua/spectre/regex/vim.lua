...
function vim_regex.change_options(_) end

function vim_regex.matchstr(search_text, search_query)
...
function vim_regex.replace_all(search_query, replace_query, text)
...
function vim_regex.match_text_line(match, str, padding)
...
function vim_regex.replace_file(filepath, lnum, search_query, replace_query) end
